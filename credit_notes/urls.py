...
urlpatterns = [
    ...
    path("clientes/<uuid:pk>/editar/", views.cliente_edit, name="cliente_edit"),
    path("clientes/<uuid:pk>/eliminar/", views.cliente_delete, name="cliente_delete"),
    ...
    path("notas/<uuid:pk>/eliminar/", views.nota_delete, name="nota_delete"),
    ...
    path("notas/<uuid:pk>/agentes/analizar/", views.agent_analysis_start, name="agent_analysis_start"),
    path("agentes/ejecuciones/<uuid:execution_id>/decidir/", views.agent_analysis_decide, name="agent_analysis_decide"),
    path("api/langgraph/estructura/", views.agent_flow_architecture_api, name="agent_flow_architecture_api"),
    path("api/notas/<uuid:pk>/langgraph/ejecuciones/", views.agent_flow_executions_api, name="agent_flow_executions_api"),
    path("api/langgraph/ejecuciones/<uuid:execution_id>/", views.agent_flow_execution_api, name="agent_flow_execution_api"),
    path("notas/<uuid:pk>/sugerencias/", views.suggestion_review, name="suggestion_review"),
    path("notas/<uuid:pk>/sugerencias/aceptar-todas/", views.suggestions_accept_all, name="suggestions_accept_all"),
    path("notas/<uuid:pk>/sugerencias/rechazar-todas/", views.suggestions_reject_all, name="suggestions_reject_all"),
    ...
    path("validacion/<uuid:pk>/reintentar-explicacion/", views.validation_explanation_retry, name="validation_explanation_retry"),
    ...
    path("negociacion/<uuid:pk>/eliminar/", views.negotiation_delete, name="negotiation_delete"),
