...
urlpatterns = [
    ...
    path("validaciones/<uuid:validation_id>/editar/", views.validation_edit, name="validation_edit"),
    path("validaciones/<uuid:validation_id>/eliminar/", views.validation_delete, name="validation_delete"),
